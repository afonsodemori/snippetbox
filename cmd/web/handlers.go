...
import (
	...
	"afonso.dev/snippetbox/internal/models"
	"afonso.dev/snippetbox/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// Can call with .Validator or without it (shadowing)
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	redir := app.sessionManager.PopString(r.Context(), "redirectAfterLogin")
	if redir == "" {
		redir = "/snippet/create"
	}
